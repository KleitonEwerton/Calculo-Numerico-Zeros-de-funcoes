#onde f é a função para a qual se quer procurar um zero, a e b são os extremos do intervalo inicial, 
#tol é a tolerância para o critério de parada (|b ? a| < tol) e x é estimativa para a raiz
